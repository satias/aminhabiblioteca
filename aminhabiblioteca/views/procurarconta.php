        ...
        <div class="identificacao d-flex mx-3">
            <div class="my-auto identificacao-texto texto-font d-flex flex-column">
                <span>
                    ...
                    <a href="<?php echo get_link("procurarconta") ?>" id="identidade-site" class="color-text"><?php echo $procont ?></a>
                </span>
                <span class="color-text"><?php echo $procont ?></span>
            </div>
        ...
        <div class="grid-procurarconta px-5">
            <div class="grid-utilizador-info">
                <div class="col-item s-back-1 p-3 d-flex flex-row align-items-center justify content-between" id="col-pesquisa">
                    ...
                    <div class="d-flex flex-row flex-nowrap color-text subtitulo-font border-1-text py-2 border-10">
                        <span class="px-2 <?php echo (!empty($user_detalhes['data']) && $user_detalhes['data']['user_type'] == 3) ? '' : 'opacidade-60'; ?>"><?php echo $user ?></span>
                        <span class="px-2 <?php echo (!empty($user_detalhes['data']) && $user_detalhes['data']['user_type'] <= 2) ? '' : 'opacidade-60'; ?>"><?php echo $funcionario ?></span>
                    </div>
                </div>
